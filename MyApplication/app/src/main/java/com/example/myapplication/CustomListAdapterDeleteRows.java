...
public class CustomListAdapterDeleteRows extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        TextView mtextView4 = (TextView) view.findViewById(R.id.textView4);

        TextView mtextView5 = (TextView) view.findViewById(R.id.textView5);
        ...
        mtextView4.setText(user.getUseremail());
        mtextView5.setText(user.getUseremail());
