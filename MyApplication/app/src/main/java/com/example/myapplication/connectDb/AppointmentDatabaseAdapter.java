...
import com.example.myapplication.models.AppointmentModel;
...
public class AppointmentDatabaseAdapter {
    ...
    public static String insertEntry(int user_id, String appointmentContent, String hour, LocalDateTime date)
    {
    ...
    public static ArrayList<AppointmentModel> getRows() throws JSONException {
        ...
        while (projCursor.moveToNext()) {
            ...
            appointment.setUerID(projCursor.getString(projCursor.getColumnIndexOrThrow("user_id")));
